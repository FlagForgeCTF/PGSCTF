...
public class Server
{
    ...
    {
        // PGSCTF Banner ASCII Art
        // Core: AGPLv3; Restricted components: LicenseRef-PGSCTF-Restricted
        ...
        Console.WriteLine($"PGSCTF © 2022-{currentYear} FlagForge {versionStr,33}\n");
