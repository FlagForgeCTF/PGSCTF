...
using PGSCTF.Repositories;
using PGSCTF.Repositories.Interface;
using PGSCTF.Services;
using PGSCTF.Services.Cache;
using PGSCTF.Services.Config;
using PGSCTF.Services.Container;
using PGSCTF.Services.CronJob;
using PGSCTF.Services.Mail;
using PGSCTF.Services.Token;
using PGSCTF.Services.Transfer;
using Microsoft.AspNetCore.HttpOverrides;
using Microsoft.AspNetCore.ResponseCompression;

namespace PGSCTF.Extensions.Startup;
    ...
    extension(WebApplicationBuilder builder)
    {
        ...
        internal void AddDevelopmentServices()
        {
            ...
            builder.Services.AddOpenApiDocument(settings =>
            {
                ...
                settings.Version = "v1";
                settings.Title = "PGSCTF Server API";
                settings.Description = "PGSCTF Server API Document";
