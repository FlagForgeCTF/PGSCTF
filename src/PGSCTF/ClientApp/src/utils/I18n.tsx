          ...
          children: (
            <>
              ...
              <List>
                ...
                <List.Item>
                  Contact us on{' '}
                  <Anchor href="https://github.com/flagforgeCTF/PGSCTF" target="_blank" rel="noreferrer">
                    GitHub
                  </Anchor>
                </List.Item>
                <List.Item>
                  Track the progress on{' '}
                  <Anchor href="https://crowdin.com/project/PGSCTF" target="_blank" rel="noreferrer">
                    Crowdin
                  </Anchor>
                </List.Item>
              </List>
