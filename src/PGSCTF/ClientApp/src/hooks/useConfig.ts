...
const RepoMeta = {
  ...
  repo: 'https://github.com/flagforgeCTF/PGSCTF',
}
...
const showBanner = () => {
  ...
  // PGSCTF Banner Block
  // Core licensed under AGPLv3; certain components under LicenseRef-PGSCTF-Restricted.
...
%cCopyright (C) ${current}, FlagForge, All rights reserved.
