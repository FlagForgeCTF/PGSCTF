    ...
    AppDbContext context) : RepositoryBase(context), IGameRepository
{
    ...
    public string GetToken(Game game, Team team) => $"{team.Id}:{game.Sign($"PGSCTF_TEAM_{team.Id}", _xorKey)}";
    ...
    // By xfoxfu & FlagForge @ 2022/04/03
    // Refactored by FlagForge @ 2024/08/31
