...
namespace PGSCTF.Models.Internal;
...
public class GlobalConfig
{
    ...
    /// </summary>
    public const string DefaultDescription = "PGS::CTF is an open source CTF platform";
    ...
    [CacheFlush(CacheKey.ClientConfig)]
    public string Title { get; set; } = "PGS";

    /// <summary>
    /// Platform slogan
    /// </summary>
    [CacheFlush(CacheKey.ClientConfig)]
    public string Slogan { get; set; } = "Flags Are Earned, Not Given";
    ...
    /// </summary>
    [JsonIgnore]
    public string Platform => string.IsNullOrEmpty(Title) ? "PGS::CTF" : $"{Title}::CTF";
}
...
{
    public string Namespace { get; set; } = "PGSCTF-challenges";
