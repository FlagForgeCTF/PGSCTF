...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ApiToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Attachment", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.CheatInfo", b =>
                {
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Config", b =>
                {
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Container", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Division", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.DivisionChallengeConfig", b =>
                {
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ExerciseChallenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ExerciseDependency", b =>
                {
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ExerciseInstance", b =>
                {
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.FirstSolve", b =>
                {
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.FlagContext", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Game", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.GameChallenge", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.GameEvent", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.GameInstance", b =>
                {
                    b.Property<int>("ChallengeId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.GameNotice", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.LocalFile", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.LogModel", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Participation", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Post", b =>
                {
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Submission", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Team", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.UserInfo", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.UserParticipation", b =>
                {
                    b.Property<int>("GameId")
                        .HasColumnType("integer");
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ApiToken", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.UserInfo", "Creator")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Attachment", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.LocalFile", "LocalFile")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.CheatInfo", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.Game", "Game")
                        .WithMany()
                        .HasForeignKey("GameId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PGSCTF.Models.Data.Participation", "SourceTeam")
                        .WithMany()
                        .HasForeignKey("SourceTeamId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PGSCTF.Models.Data.Submission", "Submission")
                        .WithMany()
                        .HasForeignKey("SubmissionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PGSCTF.Models.Data.Participation", "SubmitTeam")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.DivisionChallengeConfig", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.GameChallenge", "Challenge")
                        .WithMany("DivisionConfigs")
                        .HasForeignKey("ChallengeId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PGSCTF.Models.Data.Division", "Division")
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ExerciseChallenge", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.Attachment", "Attachment")
                        .WithMany()
                        .HasForeignKey("AttachmentId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PGSCTF.Models.Data.Container", "TestContainer")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ExerciseDependency", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.ExerciseChallenge", "Source")
                        .WithMany()
                        .HasForeignKey("SourceId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PGSCTF.Models.Data.ExerciseChallenge", "Target")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.ExerciseInstance", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.Container", "Container")
                        .WithOne("ExerciseInstance")
                        .HasForeignKey("PGSCTF.Models.Data.ExerciseInstance", "ContainerId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PGSCTF.Models.Data.ExerciseChallenge", "Exercise")
                        .WithMany()
                        .HasForeignKey("ExerciseId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("PGSCTF.Models.Data.FlagContext", "FlagContext")
                        .WithMany()
                        .HasForeignKey("FlagId")
                        .OnDelete(DeleteBehavior.SetNull);

                    b.HasOne("PGSCTF.Models.Data.UserInfo", "User")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.FirstSolve", b =>
                {
                    ...
                    b.HasOne("PGSCTF.Models.Data.Participation", "Participation")
                        .WithMany("FirstSolves")
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.GameEvent", b =>
                {
                    ...
                    b.HasOne("PGSCTF.Models.Data.Team", "Team")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.GameInstance", b =>
                {
                    ...
                    b.HasOne("PGSCTF.Models.Data.Container", "Container")
                        ...
                        .HasForeignKey("PGSCTF.Models.Data.GameInstance", "ContainerId")
                        .OnDelete(DeleteBehavior.SetNull);
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Participation", b =>
                {
                    ...
                    b.HasOne("PGSCTF.Models.Data.LocalFile", "Writeup")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Post", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.UserInfo", "Author")
                        .WithMany()
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Submission", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.GameChallenge", "GameChallenge")
            ...
            modelBuilder.Entity("PGSCTF.Models.Data.Team", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.UserInfo", "Captain")
                        .WithMany()
            ...
            modelBuilder.Entity("Microsoft.AspNetCore.Identity.IdentityUserClaim<System.Guid>", b =>
                {
                    b.HasOne("PGSCTF.Models.Data.UserInfo", null)
                        .WithMany()
                        .HasForeignKey("UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
            ...
            modelBuilder.Entity("TeamUserInfo", b =>
                {
                    ...
                    b.HasOne("PGSCTF.Models.Data.Team", null)
                        .WithMany()
