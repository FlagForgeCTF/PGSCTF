...
using PGSCTF.Integration.Test.Base;
using PGSCTF.Models;
using PGSCTF.Models.Data;
using PGSCTF.Models.Request.Account;
using PGSCTF.Models.Request.Edit;
using PGSCTF.Models.Request.Game;
...
namespace PGSCTF.Integration.Test.Tests.Api;
...
public class EditControllerTests(PGSCTFApplicationFactory factory, ITestOutputHelper output)
{
    /// <summary>
    ...
    public async Task TestContainerOperations_ShouldRetrieveFlagSuccessfully()
    {
        ...
        var challenge = await challengeRepo.CreateChallenge(gameEntity,
            new GameChallenge
            {
                ...
                GameId = game.Id,
                IsEnabled = true,
                ContainerImage = "ghcr.io/PGSCTF/challenge-base/echo:latest",
                ExposePort = 70,
                MemoryLimit = 64,
                CPUCount = 1,
                StorageLimit = 256
        ...
        try
        {
            ...
            Assert.Equal("flag{PGSCTF_dynamic_flag_test}", flag);
