...
public class GameExportImportTests(PGSCTFApplicationFactory factory, ITestOutputHelper output)
{
    /// <summary>
    ...
    private async Task ValidateExportedZipStructure(string zipPath, Game originalGame)
    {
        ...
        Assert.Equal("PGSCTF-GAME", manifest.Format);
