...
using TaskStatus = PGSCTF.Utils.TaskStatus;

namespace PGSCTF.Integration.Test.Tests.Repository;

/// <summary>
/// Integration tests for GameChallengeRepository focusing on flag management and challenge operations
/// </summary>
[Collection(nameof(IntegrationTestCollection))]
public class GameChallengeRepositoryTests(PGSCTFApplicationFactory factory, ITestOutputHelper output)
{
    [Fact]
